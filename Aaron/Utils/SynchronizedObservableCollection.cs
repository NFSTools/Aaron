...
namespace Aaron.Utils
{
    ...
    public sealed class SynchronizedObservableCollection<T> : IList<T>, IReadOnlyList<T>, IList, INotifyCollectionChanged, INotifyPropertyChanged, ISerializable
    {
        ...
        private sealed class ThreadView
        {
            ...
            private readonly SynchronizedObservableCollection<T> _owner;                     // the collection
            ...
            public ThreadView(SynchronizedObservableCollection<T> owner)
            {
                _owner = owner;
        ...
        /// </summary>
        public SynchronizedObservableCollection(SerializationInfo info, StreamingContext context)
